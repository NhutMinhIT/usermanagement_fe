...
import {
    BUTTON_CANCEL_CREATE_USER_DATA_TEST_ID,
    BUTTON_CANCEL_CREATE_USER_TEXT,
    BUTTON_SUBMIT_CREATE_USER_DATA_TEST_ID,
    BUTTON_SUBMIT_CREATE_USER_TEXT,
    DIALOG_CREATE_USER_DATA_TEST_ID,
    DIALOG_CREATE_USER_TITLE,
    SELECT_ROLE_DATA_TESTID,
    SELECT_ROLE_LABEL_ID,
    SELECT_ROLE_NAME,
    SELECT_ROLE_TITLE,
    ...
    TEXTFIELD_PASSWORD_DATA_TESTID,
    TEXTFIELD_PASSWORD_LABEL,
    TEXTFIELD_PASSWORD_NAME,
