export const LOGIN_TITLE: string = "Login";
...
export const LOGIN_BUTTON_SUBMIT: string = "Login";
export const LOGIN_BUTTON_SUBMIT_DATA_TESTID: string = "login-button";

export const LOGIN_BUTTON_REGISTER: string = "Don't have an account? Sign Up";
export const FORGOT_PASSWORD: string = "Forgot Password?";

//validation
export const LOGIN_FORM_USERNAME_REQUIRED: string = "Username is required";
export const LOGIN_FORM_PASSWORD_REQUIRED: string = "Password is required";